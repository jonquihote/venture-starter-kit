        ...
        return $schema
            ->components([
                Section::make()
                    ->schema([
                        TextEntry::make('name')
                            ->label(__('home::filament/resources/account/infolist.entries.name.label'))
                            ->columnSpanFull(),

                        TextEntry::make('username.value')
                            ->label(__('home::filament/resources/account/infolist.entries.username.label'))
                            ->columnSpan(1),

                        TextEntry::make('email.value')
                            ->label(__('home::filament/resources/account/infolist.entries.email.label'))
                            ->columnSpan(1),
                    ])
                    ->columnSpanFull()
                    ->columns(2),

                Section::make(__('home::filament/resources/account/infolist.sections.roles.heading'))
