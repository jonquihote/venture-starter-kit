...
namespace Venture\Alpha\Filament\Clusters\Administration\Resources\Memberships;
...
use Venture\Alpha\Filament\Clusters\Administration\Resources\Memberships\Pages\ManageMemberships;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Memberships\Schemas\MembershipForm;
...
class MembershipResource extends Resource
{
    ...
    {
        return __('alpha::filament/resources/membership.labels.single');
    }

    public static function getPluralModelLabel(): string
    {
        return __('alpha::filament/resources/membership.labels.plural');
    }

    public static function getNavigationLabel(): string
    {
        return __('alpha::filament/resources/membership.navigation.label');
    }
