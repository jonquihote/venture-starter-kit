...
namespace Venture\Alpha\Filament\Clusters\Administration\Resources\Applications;
...
use Venture\Alpha\Filament\Clusters\Administration\Resources\Applications\Pages\ManageApplications;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Applications\Schemas\ApplicationForm;
...
class ApplicationResource extends Resource
{
    ...
    {
        return __('alpha::filament/resources/application.labels.single');
    }

    public static function getPluralModelLabel(): string
    {
        return __('alpha::filament/resources/application.labels.plural');
    }

    public static function getNavigationLabel(): string
    {
        return __('alpha::filament/resources/application.navigation.label');
    }
