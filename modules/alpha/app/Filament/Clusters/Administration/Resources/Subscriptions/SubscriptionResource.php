...
namespace Venture\Alpha\Filament\Clusters\Administration\Resources\Subscriptions;
...
use Venture\Alpha\Filament\Clusters\Administration\Resources\Subscriptions\Pages\ManageSubscriptions;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Subscriptions\Schemas\SubscriptionForm;
...
class SubscriptionResource extends Resource
{
    ...
    {
        return __('alpha::filament/resources/subscription.labels.single');
    }

    public static function getPluralModelLabel(): string
    {
        return __('alpha::filament/resources/subscription.labels.plural');
    }

    public static function getNavigationLabel(): string
    {
        return __('alpha::filament/resources/subscription.navigation.label');
    }
