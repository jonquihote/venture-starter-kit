...
namespace Venture\Alpha\Filament\Clusters\Administration\Resources\Accounts;
...
use Venture\Alpha\Filament\Clusters\Administration\Resources\Accounts\RelationManagers\MembershipsRelationManager;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Accounts\Schemas\AccountForm;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Accounts\Schemas\AccountInfolist;
use Venture\Alpha\Filament\Clusters\Administration\Resources\Accounts\Tables\AccountsTable;
...
class AccountResource extends Resource
{
    ...
    {
        return __('alpha::filament/resources/account.navigation.label');
    }

    public static function getModelLabel(): string
    {
        return __('alpha::filament/resources/account.labels.single');
    }

    public static function getPluralModelLabel(): string
    {
        return __('alpha::filament/resources/account.labels.plural');
    }
}
