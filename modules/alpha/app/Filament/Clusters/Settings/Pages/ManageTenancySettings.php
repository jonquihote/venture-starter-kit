...
namespace Venture\Alpha\Filament\Clusters\Settings\Pages;
...
use Venture\Alpha\Filament\Clusters\Settings\SettingsCluster;
...
class ManageTenancySettings extends SettingsPage
{
                ...
                Section::make()
                    ->schema([
                        Toggle::make('is_single_team_mode')
                            ->label(__('alpha::filament/pages/settings/tenancy.form.fields.is_single_team_mode.label')),

                        Select::make('default_team_id')
                            ->label(__('alpha::filament/pages/settings/tenancy.form.fields.default_team_id.label'))
    ...
    {
        return __('alpha::filament/pages/settings/tenancy.navigation.label');
    }

    public function getTitle(): string
    {
        return __('alpha::filament/pages/settings/tenancy.title');
    }
}
